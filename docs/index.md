# go-ruby-openbao documentation

**Pure-Go OpenBao / HashiCorp Vault client (the `vault` gem), CGO=0 — bound into rbgo**

`go-ruby-openbao/openbao` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `openbao`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `openbao`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`openbao`](https://github.com/go-ruby-openbao/openbao) | the library — Ruby's `openbao` in pure Go |
| [`docs`](https://github.com/go-ruby-openbao/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-openbao.github.io`](https://github.com/go-ruby-openbao/go-ruby-openbao.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-openbao/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-openbao/openbao](https://github.com/go-ruby-openbao/openbao).
