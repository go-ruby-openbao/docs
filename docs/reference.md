...
The public API lives at the module root (`github.com/go-ruby-openbao/openbao`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `openbao`, while the surface follows
...
```go
import "github.com/go-ruby-openbao/openbao"
```
...
- **[pkg.go.dev/github.com/go-ruby-openbao/openbao](https://pkg.go.dev/github.com/go-ruby-openbao/openbao)**

The module's [README](https://github.com/go-ruby-openbao/openbao#readme) carries worked
